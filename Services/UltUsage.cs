...
namespace recognizer
{
    class UltUsage
    {
       ...
       */
        ...
        public static async Task<string> Process(IFormFile data)
        {
            ...
            UltCreditCardSdkResult result = CheckResult("Init", UltCreditCardSdkEngine.init(BuildJSON(assetsFolder)));


            using var stream = new MemoryStream();
            await data.CopyToAsync(stream);
            using var imageStream = Image.FromStream(stream);
            Bitmap image = (Bitmap)imageStream;
